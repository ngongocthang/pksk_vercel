...
const Banner = () => {
    ...
    return (
        <div 
            ...
            data-aos="fade-up" // AOS effect for the banner itself
        >
            {/* ----- Left Side ----- */}
            <div 
                className='flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5 flex flex-col justify-center items-start' 
                data-aos="fade-left" // AOS effect for the text on the left
            >
                ...
                <button
                    ...
                    className='bg-white text-sm sm:text-base text-[#00759c] px-8 py-3 border rounded-full mt-6 hover:bg-primary hover:text-white hover:scale-105 transition-all'
                    data-aos="zoom-in" // AOS effect for the button
                >
                    Tạo tài khoản
                </button>
            </div>
