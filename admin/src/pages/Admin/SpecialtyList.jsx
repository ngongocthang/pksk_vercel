        ...
        const confirmToastId = toast(
            <div className="flex flex-col items-center">
                ...
                <div className="flex justify-center gap-2">
                        ...
                        onClick={async () => {
                            try {
                                ...
                                if (response.data.success) {
                                    toast.success("Xóa chuyên khoa thành công!"); // Thông báo thành công
                                    fetchSpecialties(); // Cập nhật lại danh sách chuyên khoa
                                } else {
                                    toast.error("Xóa chuyên khoa thất bại!"); // Thông báo thất bại
                                }
                            } catch (error) {
                    ...
                    <button
                        onClick={() => toast.dismiss(confirmToastId)} // Đóng toast nếu chọn hủy
            ...
            {
                autoClose: 5000, // Đóng tự động sau 5 giây
                closeOnClick: false,
                position: "top-center",
                ...
                <table className="min-w-full table-auto bg-white border-collapse hidden md:table">
                    <thead className="bg-gray-200">
                        <tr>
                            ...
                            <th className="py-2 px-4 border-b text-sm font-bold test-center">
                                Mô Tả
                            </th>
                            <th className="py-2 px-4 border-b text-left text-sm font-bold">
                                Hành Động
