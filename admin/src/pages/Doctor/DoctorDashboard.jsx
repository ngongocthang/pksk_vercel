      ...
      <div className="flex gap-4 bg-white mt-5 mb-4 px-2">
        ...
        <div className="flex-1 bg-white p-4 rounded-lg">
          ...
          <div className="pt-4 shadow-lg">
            <table className="w-full text-sm bg-white shadow-md rounded-lg overflow-hidden table-fixed">
              {/* Table Header */}
              <thead className="bg-gray-100">
                <tr>
                  <th className="py-3 px-5 text-left text-gray-700 font-semibold w-1/4">Bệnh nhân</th>
                  <th className="py-3 px-5 text-center text-gray-700 font-semibold w-1/4">Ngày khám</th>
                  <th className="py-3 px-5 text-center text-gray-700 font-semibold w-1/4">Ca khám</th>
                  <th className="py-3 px-5 text-center text-gray-700 font-semibold w-1/4">Trạng thái</th>
                </tr>
              </thead>
            </table>
