...
function fromWireProtocol(values) {
  ...
  const res = Object.assign(new Message(), __spreadProps(__spreadValues({}, values), {
    action
  }));
  res.expandFields();
  return res;
...
function fromWireProtocol2(values) {
  ...
  return Object.assign(new PresenceMessage(), __spreadProps(__spreadValues({}, values), {
    action
  }));
}
var decode2 = decode;
  ...
  async processMessage(message) {
    ...
    switch (message.action) {
      ...
      case actions2.MESSAGE: {
        ...
        const {
          unrecoverableError
        } = await this._decodeAndPrepareMessages(message, messages, (msg) => decode(msg, this._decodingContext), (e) => {
          const errorInfo = e;
  ...
  async _decodeAndPrepareMessages(protocolMessage, messages, decodeFn, decodeErrorRecoveryHandler) {
    ...
    for (let i = 0; i < messages.length; i++) {
      ...
      try {
        ...
        logger_default.logAction(this.logger, logger_default.LOG_ERROR, "RealtimeChannel.decodeAndPrepareMessages()", e.toString());
        if (decodeErrorRecoveryHandler) {
          const {
            unrecoverableError
          } = decodeErrorRecoveryHandler(e);
          if (unrecoverableError) {
            return {
              unrecoverableError: true
            };
