...
class DefaultRealtime extends baserealtime_1.default {
    ...
    constructor(options) {
        ...
        super(defaults_1.default.objectifyOptions(options, true, 'Realtime', logger_1.default.defaultLogger, Object.assign(Object.assign({}, modularplugins_1.allCommonModularPlugins), { Crypto: (_a = DefaultRealtime.Crypto) !== null && _a !== void 0 ? _a : undefined, MsgPack, RealtimePresence: {
                ...
                presenceMessageFromWireProtocol: presencemessage_1.fromWireProtocol,
    ...
    async processMessage(message) {
        ...
        switch (message.action) {
            ...
            case protocolmessage_1.actions.PRESENCE: {
                ...
                await this._decodeAndPrepareMessages(message, presenceMessages, (msg) => (0, presencemessage_1.decode)(msg, options));
                if (this._presence) {
            ...
            case protocolmessage_1.actions.MESSAGE: {
                ...
                const { unrecoverableError } = await this._decodeAndPrepareMessages(message, messages, (msg) => (0, message_1.decode)(msg, this._decodingContext), (e) => {
    ...
    async _decodeAndPrepareMessages(protocolMessage, messages, decodeFn, decodeErrorRecoveryHandler) {
        ...
        for (let i = 0; i < messages.length; i++) {
            ...
            try {
                ...
                logger_1.default.logAction(this.logger, logger_1.default.LOG_ERROR, 'RealtimeChannel.decodeAndPrepareMessages()', e.toString());
...
class DefaultMessage extends message_1.default {
    ...
    static fromValues(values) {
        return (0, message_1.fromValues)(values);
    }
    // Used by tests
    static fromWireProtocol(values) {
        return (0, message_1.fromWireProtocol)(values);
    }
    // Used by tests
...
class DefaultPresenceMessage extends presencemessage_1.default {
    ...
    static fromValues(values) {
        return (0, presencemessage_1.fromValues)(values);
    }
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getMessagesSize = exports.fromValuesArray = exports.fromWireProtocol = exports.fromValues = exports.decode = exports.serialize = exports.encodeArray = exports.encode = exports._fromEncodedArray = exports._fromEncoded = exports.fromEncodedArray = exports.fromEncoded = exports.normalizeCipherOptions = void 0;
const tslib_1 = __webpack_require__(7582);
const platform_1 = tslib_1.__importDefault(__webpack_require__(7400));
const logger_1 = tslib_1.__importDefault(__webpack_require__(1597));
const errorinfo_1 = tslib_1.__importDefault(__webpack_require__(1798));
...
async function _fromEncoded(encoded, channel) {
    ...
    try {
        ...
        logger_1.default.logAction(channel.logger, logger_1.default.LOG_ERROR, 'Message._fromEncoded()', e.toString());
    }
    return msg;
}
...
function fromWireProtocol(values) {
    ...
    const res = Object.assign(new Message(), Object.assign(Object.assign({}, values), { action }));
    res.expandFields();
    return res;
}
exports.fromWireProtocol = fromWireProtocol;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getMessagesSize = exports.fromData = exports.fromValuesArray = exports.decode = exports.encode = exports.fromWireProtocol = exports.fromValues = exports._fromEncodedArray = exports._fromEncoded = exports.fromEncodedArray = exports.fromEncoded = void 0;
const tslib_1 = __webpack_require__(7582);
const logger_1 = tslib_1.__importDefault(__webpack_require__(1597));
const platform_1 = tslib_1.__importDefault(__webpack_require__(7400));
const message_1 = __webpack_require__(3176);
...
async function fromEncoded(logger, Crypto, encoded, inputOptions) {
    const msg = fromWireProtocol(encoded);
    const options = (0, message_1.normalizeCipherOptions)(Crypto, logger, inputOptions !== null && inputOptions !== void 0 ? inputOptions : null);
    /* if decoding fails at any point, catch and return the message decoded to
     * the fullest extent possible */
    try {
...
async function _fromEncoded(encoded, channel) {
    const msg = fromWireProtocol(encoded);
    try {
        await (0, exports.decode)(msg, channel.channelOptions);
    }
    catch (e) {
        logger_1.default.logAction(channel.logger, logger_1.default.LOG_ERROR, 'PresenceMessage._fromEncoded()', e.toString());
    }
    return msg;
}
exports._fromEncoded = _fromEncoded;
...
function fromWireProtocol(values) {
    ...
    return Object.assign(new PresenceMessage(), Object.assign(Object.assign({}, values), { action }));
}
exports.fromWireProtocol = fromWireProtocol;
...
function fromDeserialized(deserialized, presenceMessagePlugin) {
    ...
    if (deserialized.messages) {
        ...
        messages = dm.map((m) => (0, message_1.fromWireProtocol)(m));
    }
    let presence;
    ...
    return Object.assign(new ProtocolMessage(), Object.assign(Object.assign({}, deserialized), { presence, messages }));
}
